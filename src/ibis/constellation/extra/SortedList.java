...
public class SortedList {
	...
	public ActivityRecord [] removeSetInRange(long start, long end, int count) {

		// NOTE: this selects the smallest part of the range, which is not what we want ?		
		if (size == 0) { 
			return null;
		}
		...
		// We now have a sublist of length 'len' from 's' (inclusive) to 'e' (inclusive)
